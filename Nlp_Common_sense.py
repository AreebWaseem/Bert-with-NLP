...
def move_forward(tokens, masks=None):
    _, pooled_output = bert(tokens, attention_mask=masks, output_all_encoded_layers=False)
...
for step_num, batch_data in enumerate(tr_dataloader):
    ...
    probas = move_forward(token_ids, masks)
